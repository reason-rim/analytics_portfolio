...
export const projects: Project[] = [
  {
    ...
    thumbnail: "/projects/mall-customer-analytics.svg",
    heroImage: "/projects/mall-customer-analytics.svg",
    metrics: [
...
`,
      },
      {
        ...
        html: `
<p>An enhanced version of the well-known Mall Customers dataset from Kaggle, adjusted for consistency and depth.</p>
<h4>Columns used</h4>
<ul>
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Impact",
        body:
          "Finance and Growth reallocated 12% of quarterly spend toward the three highest Return on Investment (ROI) channels, forecasted to raise incremental revenue by 18%. The dashboard became the weekly source of truth for planning meetings and reduced ad-hoc analysis requests by 60%.",
      },
    ],
  },
  {
